...
<body>
	...
	<div id="tb_productinfo" style="padding: 2px 5px;">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			...
			iconCls="icon-edit" plain="true" onclick="editProduct();">修改</a><a
				href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-remove" onclick="removeProduct(1);" plain="true">上架</a><a
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-remove" onclick="removeProduct(0);" plain="true">下架</a>
	</div>
				...
				<table cellpadding="5">
					...
					<tr>
						...
						<td><input style="width: 150px;" id="type.id"
							...
							data-options="valueField:'id',textField:'name',url:'type/getType/1'"></input>
						</td>
					</tr>
					<tr>
						<td>商品名称:</td>
	...
	<script type="text/javascript">
		...
		// 商品上下架
		function removeProduct(flag) {
			var rows = $("#dg_productinfo").datagrid('getSelections');
			if (rows.length > 0) {
				$.messager.confirm('Confirm', '确认要修改么?', function(r) {
					if (r) {
						var ids = "";
